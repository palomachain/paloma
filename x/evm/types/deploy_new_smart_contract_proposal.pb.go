...
func (m *DeployNewSmartContractProposal) GetChainID() string {
	if m != nil {
		return m.ChainID
	}
	return ""
...
var fileDescriptor_ba75a8a2093c3d91 = []byte{
	...
	0x4c, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x83, 0xb0, 0xf5, 0x52, 0xcb, 0x72, 0x95, 0xd6, 0x31, 0x72,
	...
	,
}
...
func (m *DeployNewSmartContractProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChainID) > 0 {
		...
		i = encodeVarintDeployNewSmartContractProposal(dAtA, i, uint64(len(m.ChainID)))
		i--
		dAtA[i] = 0x1a
	}
