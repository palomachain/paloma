...
type AddChainProposal struct {
	...
	BlockHashAtHeight string `protobuf:"bytes,5,opt,name=blockHashAtHeight,proto3" json:"blockHashAtHeight,omitempty"`
}
...
func (m *AddChainProposal) GetChainID() string {
	if m != nil {
		return m.ChainID
	}
	return ""
...
var fileDescriptor_baa2ec73ba233b34 = []byte{
	...
	0x04, 0xcb, 0xe9, 0x41, 0xd8, 0x7a, 0xa9, 0x65, 0xb9, 0x4a, 0x5b, 0x18, 0xb9, 0x04, 0x1c, 0x53,
	...
	,
}
...
func (m *AddChainProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChainID) > 0 {
		...
		i = encodeVarintAddChainProposal(dAtA, i, uint64(len(m.ChainID)))
		i--
		dAtA[i] = 0x1a
	}
