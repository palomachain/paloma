...
func (_m *GravityKeeper) CastAllERC20ToDenoms(ctx types.Context) ([]evmtypes.ERC20Record, error) {
	...
	var r0 []evmtypes.ERC20Record
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context) ([]evmtypes.ERC20Record, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(types.Context) []evmtypes.ERC20Record); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]evmtypes.ERC20Record)
		}
	}
