...
type SubmitLogicCall struct {
	...
	ExecutorAddress    []byte `protobuf:"bytes,5,opt,name=executorAddress,proto3" json:"executorAddress,omitempty"`
}
...
func (m *SubmitLogicCall) GetExecutorAddress() []byte {
	if m != nil {
...
func (*TxExecutedProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_cc379548e12cc9d8, []int{5}
}
...
func (*SmartContractExecutionErrorProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_cc379548e12cc9d8, []int{6}
}
...
var fileDescriptor_cc379548e12cc9d8 = []byte{
	...
	,
}
...
func (m *SubmitLogicCall) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExecutorAddress) > 0 {
		...
		i = encodeVarintTurnstone(dAtA, i, uint64(len(m.ExecutorAddress)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Deadline != 0 {
...
func (m *SubmitLogicCall) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.ExecutorAddress = append(m.ExecutorAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.ExecutorAddress == nil {
				m.ExecutorAddress = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
