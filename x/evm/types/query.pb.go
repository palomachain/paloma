...
import (
	...
	turnstone "github.com/palomachain/paloma/x/evm/types/turnstone"
...
type QueryGetValsetByIDRequest struct {
	ValsettID uint64 `protobuf:"varint,1,opt,name=valsettID,proto3" json:"valsettID,omitempty"`
...
func (m *QueryGetValsetByIDRequest) GetValsettID() uint64 {
	if m != nil {
		return m.ValsettID
	}
	return 0
...
type QueryGetValsetByIDResponse struct {
	Valset *turnstone.Valset `protobuf:"bytes,1,opt,name=valset,proto3" json:"valset,omitempty"`
}
...
func (m *QueryGetValsetByIDResponse) GetValset() *turnstone.Valset {
	if m != nil {
		return m.Valset
	}
	return nil
...
var fileDescriptor_11c0d37eed5339f7 = []byte{
	...
	,
}
...
func (m *QueryGetValsetByIDRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ValsettID != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.ValsettID))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *QueryGetValsetByIDRequest) Size() (n int) {
	...
	_ = l
	if m.ValsettID != 0 {
		n += 1 + sovQuery(uint64(m.ValsettID))
	}
	l = len(m.ChainID)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
...
func (m *QueryGetValsetByIDRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValsettID", wireType)
			}
			m.ValsettID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ValsettID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
