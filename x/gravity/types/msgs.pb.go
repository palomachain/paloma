...
type MsgSendToPalomaClaim struct {
	...
	GravityNonce     uint64                `protobuf:"varint,10,opt,name=gravity_nonce,json=gravityNonce,proto3" json:"gravity_nonce,omitempty"`
}
...
func (m *MsgSendToPalomaClaim) GetGravityNonce() uint64 {
	if m != nil {
		return m.GravityNonce
	}
	return 0
}
...
type MsgBatchSendToEthClaim struct {
	...
	GravityNonce     uint64             `protobuf:"varint,8,opt,name=gravity_nonce,json=gravityNonce,proto3" json:"gravity_nonce,omitempty"`
}
...
func (m *MsgBatchSendToEthClaim) GetGravityNonce() uint64 {
	if m != nil {
		return m.GravityNonce
	}
	return 0
...
func (m *MsgSendToPalomaClaim) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.GravityNonce != 0 {
		i = encodeVarintMsgs(dAtA, i, uint64(m.GravityNonce))
		i--
		dAtA[i] = 0x50
	}
	{
...
func (m *MsgSendToPalomaClaim) Size() (n int) {
	...
	n += 1 + l + sovMsgs(uint64(l))
	if m.GravityNonce != 0 {
		n += 1 + sovMsgs(uint64(m.GravityNonce))
	}
	return n
}
...
func (m *MsgSendToPalomaClaim) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GravityNonce", wireType)
			}
			m.GravityNonce = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GravityNonce |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
