...
// source: palomachain/paloma/gravity/bridge_tax.proto
...
func (m *BridgeTax) String() string { return proto.CompactTextString(m) }
func (*BridgeTax) ProtoMessage()    {}
func (*BridgeTax) Descriptor() ([]byte, []int) {
	return fileDescriptor_c9fbd6ca12c876f6, []int{0}
}
...
var xxx_messageInfo_BridgeTax proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*BridgeTax)(nil), "palomachain.paloma.gravity.BridgeTax")
}

func init() {
	proto.RegisterFile("palomachain/paloma/gravity/bridge_tax.proto", fileDescriptor_c9fbd6ca12c876f6)
}

var fileDescriptor_c9fbd6ca12c876f6 = []byte{
	// 288 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *BridgeTax) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Rate) > 0 {
		i -= len(m.Rate)
		copy(dAtA[i:], m.Rate)
		i = encodeVarintBridgeTax(dAtA, i, uint64(len(m.Rate)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintBridgeTax(dAtA []byte, offset int, v uint64) int {
	offset -= sovBridgeTax(v)
	base := offset
	for v >= 1<<7 {
...
func (m *BridgeTax) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: BridgeTax: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BridgeTax: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func skipBridgeTax(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowBridgeTax
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthBridgeTax
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupBridgeTax
			}
			depth--
		case 5:
			iNdEx += 4
