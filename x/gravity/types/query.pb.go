...
func init() {
	...
	proto.RegisterType((*QueryBridgeTransferLimitsResponse)(nil), "palomachain.paloma.gravity.QueryBridgeTransferLimitsResponse")
	proto.RegisterType((*QueryBridgeTransferLimitsResponse_LimitUsage)(nil), "palomachain.paloma.gravity.QueryBridgeTransferLimitsResponse.LimitUsage")
}
...
func (c *queryClient) GetBridgeTransferLimits(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*QueryBridgeTransferLimitsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/palomachain.paloma.gravity.Query/GetBridgeTransferLimits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetBridgeTransferLimits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/palomachain.paloma.gravity.Query/GetBridgeTransferLimits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
