...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"volumefi", "cronchain", "consensus", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_QueuedMessagesForSigning_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"volumefi", "cronchain", "consensus", "queued_messages_for_signing"}, "", runtime.AssumeColonVerbOpt(true)))
)
