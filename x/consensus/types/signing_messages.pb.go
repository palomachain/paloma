...
// source: consensus/signing_messages.proto
...
func init() {
	proto.RegisterType((*SignSmartContractExecute)(nil), "volumefi.cronchain.consensus.SignSmartContractExecute")
}

func init() { proto.RegisterFile("consensus/signing_messages.proto", fileDescriptor_2151307b443a93c4) }
