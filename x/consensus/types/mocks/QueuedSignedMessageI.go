...
func (_m *QueuedSignedMessageI) GetGasEstimate() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetGasEstimate")
	}
...
func (_m *QueuedSignedMessageI) GetGasEstimates() []*types.GasEstimate {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetGasEstimates")
	}

	var r0 []*types.GasEstimate
	if rf, ok := ret.Get(0).(func() []*types.GasEstimate); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*types.GasEstimate)
		}
	}
...
func (_m *QueuedSignedMessageI) GetHandledAtBlockHeight() *math.Int {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetHandledAtBlockHeight")
	}
...
func (_m *QueuedSignedMessageI) GetRequireGasEstimation() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetRequireGasEstimation")
	}
