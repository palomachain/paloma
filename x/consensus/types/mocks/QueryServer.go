...
func (_m *QueryServer) QueuedMessagesForGasEstimation(_a0 context.Context, _a1 *types.QueryQueuedMessagesForGasEstimationRequest) (*types.QueryQueuedMessagesForGasEstimationResponse, error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for QueuedMessagesForGasEstimation")
	}

	var r0 *types.QueryQueuedMessagesForGasEstimationResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryQueuedMessagesForGasEstimationRequest) (*types.QueryQueuedMessagesForGasEstimationResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryQueuedMessagesForGasEstimationRequest) *types.QueryQueuedMessagesForGasEstimationResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QueryQueuedMessagesForGasEstimationResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QueryQueuedMessagesForGasEstimationRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
