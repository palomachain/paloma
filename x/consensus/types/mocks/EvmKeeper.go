...
func (_m *EvmKeeper) PickValidatorForMessage(ctx types.Context, chainReferenceID string, requirements *xchain.JobRequirements) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, string, *xchain.JobRequirements) (string, error)); ok {
		return rf(ctx, chainReferenceID, requirements)
	}
	if rf, ok := ret.Get(0).(func(types.Context, string, *xchain.JobRequirements) string); ok {
		r0 = rf(ctx, chainReferenceID, requirements)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(types.Context, string, *xchain.JobRequirements) error); ok {
