...
func (k Keeper) ScheduleNow(ctx sdk.Context, jobID string, in []byte, senderPubKey []byte) error {
	...
	err = chain.ExecuteJob(ctx, job.GetDefinition(), payload, senderPubKey, router.GetChainReferenceID())
