...
var pattern_Msg_UpdateParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"palomachain", "paloma", "params"}, "", runtime.AssumeColonVerbOpt(false)))
