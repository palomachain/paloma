...
// source: palomachain/paloma/skyway/bridge_tax.proto
...
func init() {
	proto.RegisterType((*BridgeTax)(nil), "palomachain.paloma.skyway.BridgeTax")
}

func init() {
	proto.RegisterFile("palomachain/paloma/skyway/bridge_tax.proto", fileDescriptor_c9fbd6ca12c876f6)
}
