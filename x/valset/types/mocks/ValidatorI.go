...
// NewStakingValidatorI creates a new instance of StakingValidatorI. It also registers a cleanup function to assert the mocks expectations.
func NewStakingValidatorI(t testing.TB) *StakingValidatorI {
