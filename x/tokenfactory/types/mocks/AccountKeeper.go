...
// SetModuleAccount provides a mock function with given fields: ctx, macc
func (_m *AccountKeeper) SetModuleAccount(ctx context.Context, macc types.ModuleAccountI) {
	_m.Called(ctx, macc)
}
