...
protoc -I proto -I third_party/proto/ --gocosmos_out=plugins=interfacetype+grpc,Mgoogle/protobuf/any.proto=github.com/cosmos/cosmos-sdk/codec/types:.  proto/**/*.proto


cp -r ./github.com/terra-money/core/x/wasm/types runner/client/terra/types
cp -r ./github.com/volumefi/cronchain/runner/* runner
cp -r ./github.com/volumefi/cronchain/x/scheduler/* x/scheduler
